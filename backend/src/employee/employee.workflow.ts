...
export class EmployeeWorkflow {
  ...
  submitTimesheet(
    ...
    this.data.notifications.unshift({
      id: `notification-submitted-${timesheet.id}-${timesheet.version}`,
      userId: actor.userId,
      category: "timesheet",
  ...
  private toTimesheetResponse(timesheet: EmployeeTimesheet, actor: RequestActor) {
  ...
  private assertEditable(status: EmployeeTimesheet["status"]): void {
  ...
  private recordRevision(timesheet: EmployeeTimesheet): void {
